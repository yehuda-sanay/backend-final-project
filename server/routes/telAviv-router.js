...
TelAvivRouter.get('/getAllCoffeeOrderProfitTelAviv',getAllCoffeeOrderProfitTelAviv)
TelAvivRouter.get('/getOrderByDay1TelAviv',getOrderByDay1TelAviv)
TelAvivRouter.get('/getOrderByDay2TelAviv',getOrderByDay2TelAviv)
TelAvivRouter.get('/getOrderByDay3TelAviv',getOrderByDay3TelAviv)
TelAvivRouter.get('/getOrderByDay4TelAviv',getOrderByDay4TelAviv)
TelAvivRouter.get('/getOrderByDay5TelAviv',getOrderByDay5TelAviv)
TelAvivRouter.get('/getOrderByDay6TelAviv',getOrderByDay6TelAviv)
TelAvivRouter.get('/getOrderByDay7TelAviv',getOrderByDay7TelAviv)
TelAvivRouter.post('/addOrderFromTelAviv', addOrderFromTelAviv);
// usersRouter.put('/update/:id', updateUser);
// TelAvivRouter.delete('/deleteOrdersFromTelAviv', deleteOrdersFromTelAviv);

module.exports = TelAvivRouter